...
々 _${prefix}ytsearch <link>_
々 _${prefix}ytmp4 <link>_
々 _${prefix}tiktokmp3 <link>_
々 _${prefix}tiktokmp4 <link>_
々 _${prefix}imgsearch <query>_

『 *OTHER MENU* 』
々 _${prefix}pinterest <query>_
々 _${prefix}wiki <query>_
々 _${prefix}tourl <replyimg>_
々 _${prefix}toimg <replyimg>_
々 _${prefix}takestick <author|pack>_
々 _${prefix}sticker <replyimg>_
々 _${prefix}quotesharian_

『 *FUN MENU* 』
々 _${prefix}truth <query>_
々 _${prefix}dare <query>_
々 _${prefix}simi <text>_ 

`           
           but = [
          { buttonId: `${prefix}owner1`, buttonText: { displayText: 'C️REATOR' }, type: 1 },
           { buttonId: `${prefix}USEBOT`, buttonText: { displayText: 'HOW TO USE' }, type: 1 },
          { buttonId: `${prefix}ruls`, buttonText: { displayText: 'RULES BOT' }, type: 1 }
                  ]
...
々 _${prefix}self_
々 _${prefix}hidetag_
々 _${prefix}upswteks <query>_
々 _${prefix}upswvideo <Video>_
々 _${prefix}upswimage <Foto>_
々 _${prefix}speed_`
const peb = {
            contextInfo: {
...
└ *Wiki :* ${resa[0].wiki}`
        ...
        break
         ...
         + `FN:LordAdit\n`
         + `ORG: r Bot ;\n`
         + `TEL;type=CELL;type=VOICE;waid=6285213510153:6285213510153\n`
         + 'END:VCARD'.trim()
         pebz.sendMessage(from, {displayName: `r Bot`, vcard: vcard2}, contact, 
         { quoted: fkontak, 
         })
         reply('*_Jangan Lupa Follow_*\nhttps://m.instagram.com/aditxyz1')
         break
          case 'bc':
         if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
